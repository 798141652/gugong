...
!function(e) {
	...
	function k(e) {
		var t = /(\.[a-z0-9]+)$/i,
			...
			a = e,
			o = "";
		i.test(e) && (o = RegExp.$1, e = e.replace(i, "")), t.test(e) && (n = RegExp.$1, a = e.replace(t, ""));var r,
			s = a;
	...
	return i.prototype = {
				...
				if (this._mergeGlobalConifg(t), !this._noDataCheck(t)) {
					...
					if (i)
						if (l || -1 == i.indexOf("rgba"))
							this.dom.style.backgroundColor = i;else {
							var n = i.split(",");
					...
					for (var s, h, d, c = [ "title", "legend", "tooltip", "dataRange", "roamController", "grid", "dataZoom", "xAxis", "yAxis", "polar" ], m = 0, p = c.length; p > m; m++) h = c[m], d = this.component[h], t[h] ? (d ? d.refresh && d.refresh(t) : (s = r.get(/^[xy]Axis$/.test(h) ? "axis" : h), d = new s(this._themeConfig, this._messageCenter, this._zr, t, this, h), this.component[h] = d), this._chartList.push(d)) : d && (d.dispose(), this.component[h] = null,
					...
					for (V in this.chart) V == a.CHART_TYPE_ISLAND || g[V] || (this.chart[V].dispose(), this.chart[V] = null,
						delete this.chart[V]
						);
			...
			addData : function(e, t, i, n, r) {
				...
				for (var l = e instanceof Array ? e : [ [ e, t, i, n, r ] ], h = this.getOption(), d = this._optionRestore, c = this, m = 0, p = l.length; p > m; m++) {
					e = l[m][0], t = l[m][1], i = l[m][2], n = l[m][3], r = l[m][4];var u = d.series[e],
						V = i ? "unshift" : "push",
						U = i ? "pop" : "shift";
					if (u) {
						var g = u.data,
			...
			dispose : function() {
				...
				e &&
				delete d[e]
				, this._island.dispose(), this._toolbox.dispose(), this._timeline && this._timeline.dispose(), this._messageCenter.unbind(), this.clear(), this._zr.dispose(), this._zr = null
			}
		}, s
	...
	function t(e, t, n, a, r) {
		i.call(this, e, t, n, a, r), this._nameConnector, this._valueConnector, this._zrHeight = this.zr.getHeight(), this._zrWidth = this.zr.getWidth();var l = this;
	...
	function t(e, t, n, a, o) {
		i.call(this, e, t, n, a, o), this.dom = o.dom, this._magicType = {}, this._magicMap = {}, this._isSilence = !1, this._iconList, this._iconShapeMap = {}, this._featureTitle = {}, this._featureIcon = {}, this._featureColor = {}, this._featureOption = {}, this._enableColor = "red", this._disableColor = "#ccc", this._markShapeList = [];var r = this;
			...
			reset : function(e, t) {
				...
				for (var r in this._magicType)
					if (this._magicType[r]) {
						this.option = e, this.getMagicOption();break
				}
				var s = e.dataZoom;
				if (s && s.show) {
	...
	function t(e, t, o, r, s) {
		i.call(this, e, t, o, r, s), this.dom = s.dom;var l = this;
								...
								case s.CHART_TYPE_SCATTER:
									for (var m = e.dataIndex, a = 0, o = g.length; o > a; a++)
										if (null == g[a]._mark && l.get(g[a], "seriesIndex") == t && l.get(g[a], "dataIndex") == m) {
											this._curTarget = g[a], V = g[a].style.x, U = d.type != s.CHART_TYPE_K ? g[a].style.y : g[a].style.y[0];break
									}
									break;case s.CHART_TYPE_RADAR:
									for (var m = e.dataIndex, a = 0, o = g.length; o > a; a++)
									...
									break;case s.CHART_TYPE_MAP:
									for (var f = e.name, _ = r.mapType, a = 0, o = g.length; o > a; a++)
										if ("text" === g[a].type && g[a]._mapType === _ && g[a].style._name === f) {
											this._curTarget = g[a], V = this._curTarget.style.x + this._curTarget.position[0], U = this._curTarget.style.y + this._curTarget.position[1];break
									}
									break;case s.CHART_TYPE_CHORD:
									for (var f = e.name, a = 0, o = g.length; o > a; a++)
	...
	function m(e) {
		e = v(e), e.indexOf("rgba") < 0 && (e = u(e));var t = [],
			i = 0;
	...
	function t(e, t, i, a, o) {
		n.call(this, e, t, i, a, o);var r = this;
	...
	function i(e, t) {
		...
		if ("last" === l) e.moveTo(n + r - 2, a + s / 3), e.lineTo(n + r - 2, a), e.lineTo(n + 2, a + s / 2), e.lineTo(n + r - 2, a + s), e.lineTo(n + r - 2, a + s / 3 * 2), e.moveTo(n, a), e.lineTo(n, a);
			...
			if ("stop" === t.status) e.moveTo(n + 2, a), e.lineTo(n + r - 2, a + s / 2), e.lineTo(n + 2, a + s), e.lineTo(n + 2, a);else {
						...
						for (i = 0; !l && o > i;) {
							...
							for (var d = i; o > d; d += i) {
								if (r = e[d].x - e[d - i].x, 0 !== t.label.rotate)
									...
									s = h.getTextWidth(e[d].name, e[d].textFont);else {
									var c = e[d].name + "",
			...
			_getChainPoint : function() {
				...
				if (p > 1) {
					...
					if (V = V > 50 ? 50 : 20 > V ? 5 : V, m -= 2 * V, "number" === i.type)
						for (var U = 0; p > U; U++) u.push(d + V + m / (p - 1) * U);else {
	...
	return document.createElement("canvas").getContext ? G_vmlCanvasManager = !1 : !function() {
			...
			Q.clearRect = function() {
				...
				else if (5 == arguments.length) t = arguments[1], i = arguments[2], n = arguments[3], a = arguments[4], o = r = 0, s = c, l = m;else {
				...
				this.textMeasureEl_.innerHTML = "";try {
					this.textMeasureEl_.style.font = this.font
				} catch (n) {} return this.textMeasureEl_.appendChild(i.createTextNode(e)), {
	...
	return o.prototype.iterShape = function(e, t) {
			...
			for (var i = [], n = 0, a = this._hoverElements.length; a > n; n++) {
				i.push(this._hoverElements[n]);var o = this._hoverElements[n].hoverConnect;
				if (o) {
					var r;
			...
			if (e instanceof Array)
				for (var t = 0, o = e.length; o > t; t++) this.delRoot(e[t]);else {
				var r;
			...
			return t && (
				...
				, t instanceof n && (t._storage = null)), this
						...
						if (U) {
							...
							if (U) {
								...
								for (var x = [], k = [], v = 0; U > v; v++) {
									x.push(u[v].time / _);var L = u[v].value;
								...
								var z = function(e, o) {
										...
										if (0 !== d) {
											if (W = (o - x[v]) / d, m)
												if (I = k[v], X = k[0 === v ? v : v - 1], S = k[v > U - 2 ? U - 1 : v + 1], K = k[v > U - 3 ? U - 1 : v + 2], f) r(X, I, S, K, W, W * W, W * W * W, l(e, V), b);else {
													var c;
	...
	function i(e, t, i, o) {
		if (!t || !e) return !1;
		var r = e.type;
		v = v || L.getContext();var s = n(e, t, i, o);
		...
		case "ellipse":
			...
			return p(t, i, o, l);case "rose":
			return p(t, i, o, t.maxr);default:
			return !1
		}
	}
	function n(e, t, i, n) {
		...
		case "bezier-curve":
			...
			return d(t.pointList, t.lineWidth, i, n);case "ring":
			return c(t.x, t.y, t.r0, t.r, i, n);case "circle":
			return p(t.x, t.y, t.r, i, n);case "sector":
			var o = t.startAngle * Math.PI / 180,
				h = t.endAngle * Math.PI / 180;
			return t.clockWise || (o = -o, h = -h), u(t.x, t.y, t.r0, t.r, o, h, !t.clockWise, i, n);case "path":
			return t.pathArray && _(t.pathArray, Math.max(t.lineWidth, 5), t.brushType, i, n);case "polygon":
		case "star":
		case "isogon":
			return V(t.pointList, i, n);case "text":
			var U = t.__rect || e.getRect(t);
			return m(U.x, U.y, U.width, U.height, i, n);case "rectangle":
		case "image":
	...
	function h(e, i, n, a, o, r, s, l, h) {
		if (0 === s) return !1;
		var d = Math.max(s, 5);
		l -= e, h -= i;var c = Math.sqrt(l * l + h * h);
		...
		for (var g = "stroke" === i || "both" === i, _ = "fill" === i || "both" === i, x = 0; x < e.length; x++) {
			...
			case "M":
				...
				var L = v[0],
					...
					K = Math.cos(I) * W + L,
					C = Math.sin(I) * X + w;
				V ? (V = !1, m = K, p = C) : o += U(d, c, K, C);var T = (n - L) * X / W + L;
	...
	function t(t, n, a, o, r, s, l) {
		r && (t.font = r), t.textAlign = s, t.textBaseline = l;var h = i(n, a, o, r, s, l);
	...
	return d.prototype.doClip = function(e) {
			...
			if ("undefined" != typeof i.text && i.text !== !1) {
				...
				case "end":
					...
					s = V, l = g;var f = Math.atan((U - g) / (V - u)) / Math.PI * 180;
	...
	function l(e, t, i, a, o, r, s, l, h, d, c) {
		...
		for (var g = 0; 1 > g; g += .05) {
			b[0] = n(e, i, o, s, g), b[1] = n(t, a, r, l, g);var f = V.distSquare(y, b);
			u > f && (m = g, u = f)
		}
		u = 1 / 0;
		for (var x = 0; 32 > x && !(U > p); x++) {
			var k = m - p,
				v = m + p;
			b[0] = n(e, i, o, s, k), b[1] = n(t, a, r, l, k);var f = V.distSquare(b, y);
	...
	function u(e, t, i, n, a, o, r, s, l) {
		...
		for (var p = 0; 1 > p; p += .05) {
			b[0] = h(e, i, a, p), b[1] = h(t, n, o, p);var u = V.distSquare(y, b);
			m > u && (d = p, m = u)
		}
		m = 1 / 0;
		for (var g = 0; 32 > g && !(U > c); g++) {
			var f = d - c,
				x = d + c;
			b[0] = h(e, i, a, f), b[1] = h(t, n, o, f);var u = V.distSquare(b, y);
	...
	function i(e, t, i, n, a) {
		u.call(this, e, t, i, n, a);var o = this;
	...
	return i.prototype = {
			...
			_markPoint : function(e, t) {
				...
				var a,
					...
					f = this.zr.getWidth(),
					y = this.zr.getHeight();
				if (t.large) a = this.getLargeMarkPointShape(e, t), a._mark = "largePoint", a && p.push(a);else
			...
			_animateMod : function(e, t, i, n, a, o) {
				...
				case "circle":
					...
					break;case "gauge-pointer":
					c.gaugePointer(this.zr, e, t, i, n);
					break;case "mark-line":
					c.markline(this.zr, e, t, i, n);
					break;case "bezier-curve":
				case "line":
					...
					for (var a = !1, o = [ this.shapeList, this.effectList ], r = 2; r--;)
						for (var s = 0, l = o[r].length; l > s; s++)
							if (o[r][s]._mark == i && d.get(o[r][s], "seriesIndex") == e && d.get(o[r][s], "name") == t) {
								this.zr.delShape(o[r][s].id), o[r].splice(s, 1), a = !0;break
					}
	...
	function e(e, t) {
		...
		try {
			...
			a -= i.split(".")[1].length
		} catch (o) {} return (i.replace(".", "") - 0) / (n.replace(".", "") - 0) * Math.pow(10, a)
	}
	function t(e, t) {
		var i = e.toString(),
			n = t.toString(),
	...
	function i(e, t) {
		...
		} catch (a) {} var o = Math.pow(10, Math.max(i, n));
			...
			buildPath : function(e, t) {
				...
				if (0 !== n)
					for (var a, o, r, s, l, h = 1e4, d = Math.ceil(n / h), c = i[0] instanceof Array, m = t.size ? t.size : 2, p = m, u = m / 2, V = 2 * Math.PI, U = 0; d > U; U++) {
						...
						for (var g = a; o > g; g++)
							if (t.random && (r = t["randomMap" + g % 20] / 100, p = m * r * r, u = p / 2), c ? (s = i[g][0], l = i[g][1]) : (s = i[g].x, l = i[g].y), 3 > p) e.rect(s - u, l - u, p, p);else switch (t.iconType) {
								case "circle":
	...
	function t(e, t, i, n, a) {
		...
		o = t.style.pointList;var c = o.length;
	...
	function p(e, t, i, n, a) {
		a = a || "QuinticOut", i.__animating = !0, e.addShape(i);var o = i.style,
			r = function() {
				i.__animating = !1
			},
			s = o.xStart,
	...
	function t(e, t, i, n) {
		...
		"image" !== i.type ? (a = new h({
			...
			draggable : !1,
			hoverable : !1
		}), o.clone(i, a), a.position = i.position, t.push(a), e.addShape(a);var V = "image" !== i.type ? window.devicePixelRatio || 1 : 1,
	...
	function n(e, t, i, n, a) {
		...
		a || (o.clone(i, g), g.position = i.position, t.push(g), e.addShape(g));var y = function() {
	...
	function a(e, t, i, a) {
		...
		for (var l = 0, h = [], d = 0; d < r.length; d++) {
			r[d].effect = s;var m = n(e, null, r[d], a, !0),
				p = m.effectAnimator;
		...
		t.push(o), e.addShape(o);var u = function() {
	...
	function t(e, t, a, o, r) {
		this.ecTheme = e, this.messageCenter = t, this.zr = a, this.option = o, this.series = o.series, this.myChart = r, this.component = r.component, this.shapeList = [], this.effectList = [];var s = this;
	...
	function t(e, t) {
		e = e.array, t = t.array;var i = t[0] - e[0],
			n = t[1] - e[1],
			a = t[2] - e[2],
			o = t[3] - e[3];
			...
			_limitTurningAngle : function() {
				...
				return function(a, o, r, l) {
					...
					for (var p = 0, u = 0; u < a.length; u++) {
						...
						s.scale(t, t, 1 / U);var g = s.dot(t, e);
						if (c > g) {
	...
	return function(e, i, n, a) {
		...
		for (var u = 0, V = e.length; V > u; u++) {
			...
			if (n) o = e[u ? u - 1 : V - 1], r = e[(u + 1) % V];else {
				if (0 === u || u === V - 1) {
					h.push(t.clone(e[u]));continue
				}
				o = e[u - 1], r = e[u + 1]
			}
			t.sub(d, r, o), t.scale(d, d, i);var g = t.distance(U, o),
				f = t.distance(U, r),
				y = g + f;
	...
	function n(e, i) {
		i instanceof Array || (i = [ 0, i ]);var n = Math.min(e.getWidth(), e.getHeight()) / 2;
	...
	return n.prototype._buildTree = function(e, n, a, o) {
			...
			for (i.data !== e && (o = t(i.data, e), r = i), e.array[i.axis] < i.data.array[i.axis] ? (i.right && (n[a++] = i.right), i.left && (n[a++] = i.left)) : (i.left && (n[a++] = i.left), i.right && (n[a++] = i.right)); a--;) {
				i = n[a];var s = e.array[i.axis] - i.data.array[i.axis],
					l = 0 > s,
					h = !1;
			...
			for (a.data !== e && (d++, this._addNearest(d, h, a)), e.array[a.axis] < a.data.array[a.axis] ? (a.right && (o[r++] = a.right), a.left && (o[r++] = a.left)) : (a.left && (o[r++] = a.left), a.right && (o[r++] = a.right)); r--;) {
				a = o[r];var h = e.array[a.axis] - a.data.array[a.axis],
					c = 0 > h,
					m = !1;
			...
			_contentToOption : function(e) {
				...
				for (t = 0, o = c.length; o > t; t++)
					if (d++, c[t].type == n.CHART_TYPE_SCATTER)
						for (var i = 0, a = c[t].data.length; a > i; i++) s = e[d], l = s.replace(" ", "").split(","), "undefined" != typeof c[t].data[i].value ? c[t].data[i].value = l : c[t].data[i] = l, d++;else {
						s = e[d].split(",");
							...
							for (d = 1 > d ? 1 : d, e = Math.floor(15 / r); !h && n > e;) {
								...
								for (var c = Math.floor((n - 1) / e) * e; c >= 0; c -= e) {
									if (0 !== this.option.axisLabel.rotate)
										...
										o = l.getTextWidth(this._getReformedLabel(c), this.getFont(s.merge(i[c].textStyle, this.option.axisLabel.textStyle)));else {
				...
				if (isNaN(this.option.min - 0) || isNaN(this.option.max - 0)) {
					...
					for (var a in i) {
						...
						for (var l = 0, h = s.length; h > l; l++)
							if (!isNaN(s[l])) {
								this._hasData = !0, this._min = s[l], this._max = s[l];break
						}
	...
	function e(e, t, i) {
		...
		for (var n, a, o, r, s = 0, l = d.length; l > s; s++)
			if (n = d[s].value, a = Math.ceil(t / n) * n - Math.floor(e / n) * n, Math.round(a / n) <= 1.2 * i) {
				o = d[s].formatter, r = d[s].value;break
		}
	...
	function n(e, t, n, a) {
		y = a || {}, b = y.steps || v, _ = y.secs || L, n = W(+n || 0) % 99, e = +e || 0, t = +t || 0, x = k = 0, "min" in y && (e = +y.min || 0, x = 1), "max" in y && (t = +y.max || 0, k = 1), e > t && (t = [ e, e = t ][0]);var o = t - e;
	...
	function o(n, a, o) {
		a = W(a % 10) || 2, 0 > a && (i(n) ? a = ("" + S(n)).replace(/0+$/, "").length || 1 : (n = n.toFixed(15).replace(/0+$/, ""), a = n.replace(".", "").replace(/^[-0]+/, "").length, n = +n));var r = X(e(n)) - a + 1,
	...
	function f(e, t, i) {
		...
		S(t / s) < 1e-6 && (t = 0), S(e / s) < 1e-6 && (e = 0);var l,
			h,
			d,
	...
	function n() {
		p = U.logLabelBase, null == p ? (u = "plain", p = 10, V = S) : (p = +p, 1 > p && (p = 10), u = "exponent", V = v(p)), g = U.splitNumber, null == g && (g = E);var e = parseFloat(U.dataMin),
