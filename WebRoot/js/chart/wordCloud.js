define("echarts/chart/wordCloud", [ "require", "./base", "zrender/shape/Text", "../layout/WordCloud", "../component/grid", "../component/dataRange", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/color", "../chart" ], function(e) {
	...
	return t.prototype = {
			...
			_place : function(e, t, i) {
				...
				for (var o, r, s, l = this.defaultOption.size, h = ([ {
							...
							x : l[0],
							y : l[1]
						} ], t.x), m = t.y, V = Math.sqrt(l[0] * l[0] + l[1] * l[1]), d = this.defaultOption.spiral(l), U = Math.random() < .5 ? 1 : -1, p = -U; (o = d(p += U)) && (r = ~~o[0], s = ~~o[1], !(Math.min(r, s) > V));)
			...
			_autoCalTextSize : function(e, t, i, n, a) {
				function o(e) {
					c.clearRect(0, 0, (U << 5) / u, p / u), c.save(), c.font = e.style + " " + e.weight + " " + ~~((e.size + 1) / u) + "px " + e.font;var t = c.measureText(e.text + "m").width * u,
						r = e.size << 1;
					t = t + 31 >> 5 << 5, c.restore(), e.aw = t, e.ah = r;var s,
						l,
						h;
					if (e.rotate) {
	...
	function t(e, t, n, a, o) {
		i.call(this, e, t, n, a, o);var s = this;
