define("echarts/chart/chord", [ "require", "./base", "zrender/shape/Text", "zrender/shape/Line", "zrender/shape/Sector", "../util/shape/Ribbon", "../util/shape/Icon", "zrender/shape/BezierCurve", "../config", "../util/ecData", "zrender/tool/util", "zrender/tool/vector", "../data/Graph", "../layout/Chord", "../chart" ], function(e) {
	...
	return t.prototype = {
			...
			_getSerieGraphFromDataMatrix : function(e, t) {
				...
				for (var r = e.data || e.nodes, o = 0; o < r.length; o++) {
					...
					var d = this._getNodeCategory(t, l),
						c = d ? d.name : l.name;
			...
			_getSerieGraphFromNodeLinks : function(e, t) {
				...
				for (var a = 0, o = e.links.length; o > a; a++) {
					var d = e.links[a],
						c = d.source,
						p = d.target;
					"number" == typeof c && (c = n[c], c && (c = c.name)), "number" == typeof p && (p = n[p], p && (p = p.name));var u = i.addEdge(c, p, d);
					u && (u.rawIndex = a)
				}
						...
						for (var i = 0; i < t.length; i++) {
							...
							if (l)
								for (var o = 0; o < l.outEdges.length; o++) {
									var r = l.outEdges[o],
										s = a._getEdgeQueryTarget(t[i].__serie, r.data);
									r.shape.style.opacity = a.deepQuery(s, "opacity");var h = t[0].getNodeById(r.node2.id);
			...
			_buildLabels : function(e, t, i, a) {
				...
				i.eachNode(function(t) {
					var i = t.layout.startAngle / Math.PI * 180 * d,
						h = t.layout.endAngle / Math.PI * 180 * d,
						c = (i * -d + h * -d) / 2;
					c %= 360, 0 > c && (c += 360);
					var m = 90 >= c || c >= 270;
					c = c * Math.PI / 180;
					var u = [ Math.cos(c), -Math.sin(c) ],
						g = 0;
				...
				i.eachNode(function(t) {
					for (var i = t.layout.startAngle / Math.PI * 180, c = t.layout.endAngle / Math.PI * 180, m = i;;) {
						...
						var g = m / 180 * Math.PI,
							...
							y = p.scale([], V, h[1] + 1);
						p.add(y, y, l);var f = p.scale([], V, h[1] + this.scaleLineLength);
						p.add(f, f, l);var U = new a({
							zlevel : e.zlevel,
							z : e.z - 1,
							hoverable : !1,
							style : {
					...
					if (e.showScaleText)
						for (var _ = i, b = 5 * u * this.scaleUnitAngle, x = 0;;) {
							...
							var g = _;
							g %= 360, 0 > g && (g += 360);var k = 90 >= g || g >= 270,
								v = new n({
									zlevel : e.zlevel,
									z : e.z - 1,
									hoverable : !1,
	...
	i.prototype.isDirected = function() {
		...
		var i = e.node1,
			n = e.node2,
			a = i.id + "-" + n.id;
		this._directed && (i.outEdges.splice(t.indexOf(i.outEdges, e), 1), n.inEdges.splice(t.indexOf(n.inEdges, e), 1)), i.edges.splice(t.indexOf(i.edges, e), 1), i !== n && n.edges.splice(t.indexOf(n.edges, e), 1),
