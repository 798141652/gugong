...
public class Data2020Dao {
	public List<Integer> get2020data(){
		List<Integer> arraylist=new ArrayList<Integer>();
		try {
			
			Connection connct = MysqlDataBase.getConnct();
			String sql1="select count(*) from context_20 where time like '%-1-%' or time like '%-01-%'";
			String sql2="select count(*) from context_20 where time like '%-2-%' or time like '%-02-%'";
			String sql3="select count(*) from context_20 where time like '%-3-%' or time like '%-03-%'";
			String sql4="select count(*) from context_20 where time like '%-4-%' or time like '%-04-%'";
			String sql5="select count(*) from context_20 where time like '%-5-%' or time like '%-05-%'";
			String sql6="select count(*) from context_20 where time like '%-6-%' or time like '%-06-%'";
